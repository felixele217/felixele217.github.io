import{r as v,_ as y,C as T,a as M,E as te,o as j,F as _e,g as Ne,v as Ce,i as Oe,b as De,c as I,d as E,W as Re}from"./index-CUTW9zmY.js";const ne="@firebase/installations",F="0.6.18";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function b(){try{await Ce()}catch{return!1}return typeof window<"u"&&Oe()&&De()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
